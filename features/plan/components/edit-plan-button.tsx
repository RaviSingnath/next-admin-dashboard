...
export default function EditPlanButton({ plan }: EditPlanButtonProps) {
  ...
  return (
    <div className="absolute top-0 right-0">
      <button
        onClick={openModal}
        className="flex w-full rounded-full border border-gray-300 bg-white p-1 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200 lg:inline-flex lg:w-auto"
      >
        <Pencil size={14} />
      </button>
